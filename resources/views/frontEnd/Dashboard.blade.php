            ...
            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
              <div>
                <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                    <svg class="icon">
                      <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-arrow-bottom"></use>
                    </svg>)</span></div>
                <div>Users</div>
              </div>
              <div class="dropdown">
                <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <svg class="icon">
                    <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-options"></use>
                  </svg>
                </button>
            ...
            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
              <div>
                <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                    <svg class="icon">
                      <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-arrow-top"></use>
                    </svg>)</span></div>
                <div>Income</div>
              </div>
              <div class="dropdown">
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
              ...
              <button class="btn btn-primary" type="button">
                <svg class="icon">
                  <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-cloud-download"></use>
                </svg>
              </button>
            </div>
          </div>
      ...
      <div class="row">
          ...
          <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
            <div class="card-header position-relative d-flex justify-content-center align-items-center">
              <svg class="icon icon-3xl text-white my-4">
                <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-facebook-f"></use>
              </svg>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card mb-4" style="--cui-card-cap-bg: #00aced">
            <div class="card-header position-relative d-flex justify-content-center align-items-center">
              <svg class="icon icon-3xl text-white my-4">
                <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-twitter"></use>
              </svg>
              <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
            <div class="card-header position-relative d-flex justify-content-center align-items-center">
              <svg class="icon icon-3xl text-white my-4">
                <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-linkedin"></use>
              </svg>
              <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="progress-group">
                    <div class="progress-group-header">
                      <svg class="icon icon-lg me-2">
                        <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-user"></use>
                      </svg>
                      <div>Male</div>
                  ...
                  <div class="progress-group mb-5">
                    <div class="progress-group-header">
                      <svg class="icon icon-lg me-2">
                        <use xlink:href="assets/@coreui/icons/sprites/free.svg#cil-user-female"></use>
                      </svg>
                      <div>Female</div>
                  ...
                  <div class="progress-group">
                    <div class="progress-group-header">
                      <svg class="icon icon-lg me-2">
                        <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-google"></use>
                      </svg>
                ...
                <table class="table border mb-0">
                  ...
                  <tbody>
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-us"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-mastercard"></use>
                        </svg>
                      </td>
                      <td>
                    ...
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-br"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-visa"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="small text-medium-emphasis">Last login</div>
                    ...
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-in"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-stripe"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="small text-medium-emphasis">Last login</div>
                    ...
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-fr"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-paypal"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="small text-medium-emphasis">Last login</div>
                    ...
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-es"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-apple-pay"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="small text-medium-emphasis">Last login</div>
                    ...
                    <tr class="align-middle">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/flag.svg#cif-pl"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="clearfix">
                      ...
                      <td class="text-center">
                        <svg class="icon icon-xl">
                          <use xlink:href="assets/@coreui/icons/sprites/brand.svg#cib-cc-amex"></use>
                        </svg>
                      </td>
                      <td>
                        <div class="small text-medium-emphasis">Last login</div>
